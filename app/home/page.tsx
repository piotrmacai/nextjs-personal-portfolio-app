...
import PortfolioPage from "../portfolio/page" // Still imported, but main content is below
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        ...
                        <div>
                            ...
                            <p className={`${inter.className} text-white/70`}>
                                Go beyond code. Access the <span className="font-bold">gen.macai.dev</span> studio for on-demand generation of stunning visual content—high-quality videos, images, and creative assets powered by advanced generative AI models.
                            </p>
                        </div>
                        <Link
                            href="https://gen.macai.dev"
