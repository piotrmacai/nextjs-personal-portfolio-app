...
import { Sparkles, Zap, Bot, Workflow, BookOpen, ArrowUpRight } from "lucide-react"
import { motion } from "framer-motion"
import Link from "next/link"

export default function AinsiderSection() {
    return (
        <motion.section
                ...
                <div className="relative z-10 grid lg:grid-cols-2 gap-12 p-8 md:p-12 items-start">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <p className={`${inter.className} text-white/70 text-lg leading-relaxed`}>
                            We bridge the gap between human creativity and machine intelligence. <strong>Ainsider.co</strong> is your partner for AI transformation, delivering custom automation and agents that scale your business.
                        </p>
